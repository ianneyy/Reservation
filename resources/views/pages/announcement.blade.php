...
<div id="nav-bar">
    ...
    <div id="nav-content">
        ...
        <div class="nav-button"><a href="{{ url('student/announcement') }}">
                ...
                </svg><span style="color: #FFBD2E;">Announcements</span>
        </div>
        </a>
...
<div class="containerr px-5 col-xl-9">
    <h3 class="mb-5" style="font-size: 24px; color:#FFBD2E">Announcements</h3>
    @forelse($data as $d)
...
<!-- <script>
    ...
    // Function to determine if the date is Today, Yesterday, or another day
    ...
    function updateDateTime(dateString) {
        ...
        const time = formatTime(givenDate);

        // Update separate divs for date and time
        document.getElementById("date-display").innerText = relativeDate;
        document.getElementById("time-display").innerText = time;
    }

    // Loop through each announcement to update date/time display

   

    updateDateTime(dateFromDatabase);
</script> -->

  ...
  <div id="nav-content">
    ...
    <div class="nav-button">
      <a href="{{ url('student/reservation') }}" style="text-decoration: none; color: inherit;">
        ...
        </svg></i><span style="color: #FFBD2E;">My Reservation</span>
      </a>
    </div>
...
<div class="containerr p-5 col-xl-9">
  <form action="{{ url('student/reservation')}}" method="post">
    @csrf
    <h3 class="title">My Reservations</h3>
    <p>Manage your uniform reservations below.</p>

    <h4 class="subtitle">Current Reservations</h4>
      ...
      <table class="no-data" style="display: flex; justify-content: center; align-items: center;">
        <tr>
          <td style="text-align: center; vertical-align: middle;">
            <img src="../img/no_data.svg" alt="No Data" class="nodata-image" style="max-width: 100px; height: auto;">
            <p style="margin-top: 10px; color: #888;">No current reservation.</p>
          </td>
        </tr>
      </table>
      @endforelse
    ...
    <table>
      ...
      <tr>
        <td>{{$past->name}}</td>
        <td>{{$past->department}}</td>
        <td>{{$past->size}}</td>
        <td>{{$past->qty}}</td>
        <td>{{$past->reservation_date}}</td>
        <td>{{$past->status}}</td>
      </tr>
      @empty
      <table class="no-data" style="display: flex; justify-content: center; align-items: center;">
        <tr>
          <td style="text-align: center; vertical-align: middle;">
            <img src="../img/no_data.svg" alt="No Data" class="nodata-image" style="max-width: 100px; height: auto;">
            <p style="margin-top: 10px; color: #888;">No past reservation.</p>
          </td>
        </tr>
      </table>
      @endforelse
    ...
    <p>All reservations must be made at least [X days] in advance. Uniforms can be picked up at [wala pa].</p>

    <h4>Need Help?</h4>
    <p>Contact us at [wala pa].</p>
  </form>
</div>
